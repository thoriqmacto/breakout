...
/**
 * The market-wide session calendar: IHSG closes, per-symbol closes, and the
 * statistics above them.
 *
 * This was its own page. Per-asset history now lives on the Assets table as
 * coverage columns -- bars against the sessions the market actually held --
 * which is the question an operator was previously answering by eye across two
 * pages. What could not fold into a row is this: the calendar is market-wide,
 * not per asset, so it became the second tab rather than disappearing.
 */
